...
Launch args:
    variant   simple          which hardware variant to load (default simple)
...
def _setup(context, *args, **kwargs):
    ...
    pkg_description = get_package_share_directory('base101_simple_description')
    ...
    resource_dirs = [
        ...
        os.path.join(get_package_prefix('base101_simple_description'), 'share'),
    ]
    ...
    urdf_file = os.path.join(pkg_description, 'urdf', 'base101_simple.xacro')
