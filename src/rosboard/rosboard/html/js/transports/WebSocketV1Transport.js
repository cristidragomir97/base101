class WebSocketV1Transport {
    ...
    // Publish a single ROS message from the browser back to ROS. The backend's
    // publish_allowlist gates which topic types are actually accepted; default
    // allows only geometry_msgs/msg/Twist. `msg` is the ros2dict-shaped dict
    // (nested {linear:{x,y,z}, angular:{x,y,z}} for a Twist).
  ...
  WebSocketV1Transport.MSG_PUB = "P";
